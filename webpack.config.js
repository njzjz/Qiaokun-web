...
module.exports = {
  ...
  plugins : [
    new MiniCssExtractPlugin(
        {filename : "[name].[chunkhash].css", chunkFilename : "[id].css"}),
    ...
    new GoogleFontsPlugin({
      fonts : [
        {family : "Merriweather Sans", variants : [ "400", "700" ]}, {
          family : "Merriweather",
          variants :
              [ "400", "300", "300italic", "400italic", "700", "700italic" ]
        }
      ],
      local : false
    }),
    ...
    new SitemapWebpackPlugin(
        'http://www.shqkchem.com', [ '/' ],
        {lastMod : true, changeFreq : 'monthly', priority : '1.0'}),
    new RobotstxtPlugin({
      policy : [ {
        userAgent : "*",
        allow : "/",
